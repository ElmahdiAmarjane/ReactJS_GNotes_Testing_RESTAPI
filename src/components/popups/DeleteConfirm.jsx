...
const DeleteConfirm = ({ setRemoveClicked, userToRemove , getAllUsers }) => {

    const removeUser= async()=>{
        const user = userToRemove;
        console.log("user to remove : ",user)
       await axios.post("http://localhost:9080/gnote/api/gnotes/v1/admin/deleteUser",{
            id:user.id
        }).then((res)=>{
             console.log("res.DATA de : ",res.data);
